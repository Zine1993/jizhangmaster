...
const translations = {
  en: {
    ...
    budgetProgressAnalysis: 'Budget progress analysis',
    budgetsOngoing: 'Ongoing budgets',
    avgCompletion: 'Average completion',
    overspentCount: 'Overspent count',
  ...
  zh: {
    ...
    emotionRanking: '情绪排行',
    budgetProgressAnalysis: '预算进度分析',
    budgetsOngoing: '进行中预算',
    avgCompletion: '平均完成度',
    overspentCount: '超支个数',
    topBudget: 'Top 预算',
    overspent: '已超支',
